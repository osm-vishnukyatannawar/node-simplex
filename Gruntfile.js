module.exports = function(grunt) {
  ...
  var minifyFiles = {};
  minifyFiles[publicHTML + '/dist/emanate.main.min.js'] = [publicHTML + 'js/*.js'];
  minifyFiles[publicHTML + '/dist/emanate.ng.min.js'] = [publicHTML + 'js/app/*.js'];
  minifyFiles[publicHTML + '/dist/emanate.grid.min.js'] = gridFiles;
  
    // Project configuration.
  console.log([codePath + '*.js', publicHTML + 'js/', '!' + publicHTML + 'plugins/', '!*.min.js']);
  grunt.initConfig({
    ...
    jsbeautifier: {
      files: [codePath + '*.js', codePath + '**/*.js', publicHTML + 'js/**/*.js', '!' + publicHTML + 'plugins/**', '!' + codePath + '**/*.min.js'],      
      options: {
        js: {
          indentChar: ' ',
          indentSize: 2,
