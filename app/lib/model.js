...
// Osm includes
let DBConfig = require(__CONFIG__.app_base_path + 'db-config');
let Logger = require(__CONFIG__.app_base_path + 'logger');
let GetStatus = require(__CONFIG__.app_lib_path + 'status');
let MariaDb = require(__CONFIG__.app_lib_path + 'db-connector/mariadb');
let CassandraDb = require(__CONFIG__.app_lib_path + 'db-connector/cassandradb');
let DateUtil = require(__CONFIG__.app_helper_path + 'date-utility');
let Mailer = require(__CONFIG__.app_helper_path + 'mailer');
let Validator = require(__CONFIG__.app_helper_path + 'validator');
let Csv = require(__CONFIG__.app_helper_path + 'csv-helper');
let Zipper = require(__CONFIG__.app_helper_path + 'zipper');
